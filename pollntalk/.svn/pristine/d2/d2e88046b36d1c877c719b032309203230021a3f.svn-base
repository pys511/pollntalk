...
/*     echo "========================= 복호화 데이터 ====================="       ."<br>";
    ...
    /* $sbParam .= "<input type='hidden' name='user_name' value='" . $ct_cert->mf_get_key_value("user_name"  ) . "'/>";
    $sbParam .= "<input type='hidden' name='phone_no' value='" . $ct_cert->mf_get_key_value("phone_no"  ) . "'/>";
    $sbParam .= "<input type='hidden' name='birth_day' value='" . $ct_cert->mf_get_key_value("birth_day"  ) . "'/>";
    $sbParam .= "<input type='hidden' name='sex_code' value='" . $ct_cert->mf_get_key_value("sex_code"  ) . "'/>"; */
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
        ...
        <script type="text/javascript">
            window.onload=function()
            {
                try
                {
                    document.form_auth.user_name.value = "<?php echo $user_name?>";
                    document.form_auth.phone_no.value = "<?php echo $phone_no?>";
                    document.form_auth.birth_day.value = "<?php echo $birth_day?>";
                    document.form_auth.sex_code.value = "<?php echo $sex_code?>";
