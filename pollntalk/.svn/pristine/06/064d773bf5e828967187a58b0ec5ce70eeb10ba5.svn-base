...
$voteResult = $vote->getVoteFormListByType($vote_kind, "1", $keyword);
?>	
...
<?php 
$voteResult = $vote->getVoteFormListByType($vote_kind, "2", $keyword);
?>
		<div class="votedispcont boundray">
			<div class="votedispbox">
				<div class="votesubtitle">
...
<?php 
$voteResult = $vote->getVoteFormListByType($vote_kind, "3", $keyword);
?>
		<div class="votedispcont boundray">
			<div class="votedispbox">
				<div class="votesubtitle">
...
<?php 
$voteResult = $vote->getVoteFormListByType($vote_kind, "4", $keyword);
?>
		<div class="votedispcont boundray">
			<div class="votedispbox">
				<div class="votesubtitle">
