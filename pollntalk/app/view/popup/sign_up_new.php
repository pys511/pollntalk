...
<body>
	<form id="sign_up" name="sign_up" action="/popup.php?mode=sign_up_end" method="POST">
		...
		<div class="popcontxtarea">
			<div class="popcontxtbox">
				<div class="shortinputer">
					<input class="shortInputtext" type="text" id="email" name="email" placeholder="인증번호 입력" />
					<button id="sendauth" class="shortInputButton">
						<span>인증 확인</span>
					</button>
				</div>
				<span class="guidetext">오른쪽 인증번호 발송 버튼을 클릭하여 입력하신 이메일 주소로 인증번호를 받아 인증번호를 입력하세요.</span>
				<button id="auth" class="defaultbutton">
					<span>인증번호 발송</span>
				</button>
			</div>
		</div>
