...
?>
				...
				<div class="contentBox">
					<form id="frmMail" action="/admin_controller.php?mode=emailsend_proc" method="post">
						...
						<div class="boardBox">
							...
							<input type="hidden" id="mailFrom" name="mailFrom" value="<?php echo($_SESSION["admin_mail"]) ?>" />
							<div class="boardWriteItem">
								<div class="boardName">
									<span>받는 사람</span>
								</div>
								<div class="boardInputBox">
									<input id="mailTo" name="mailTo" type="text" class="longInput" value = "<?php if($num != ""){ echo($result["MAIL_TO"]); } else {}?>">
									<input type="checkbox" class="agree" name="allMember" id="allMember" /> 
										<label for="agree"> 
											<span>모든 회원</span>
										</label>
								</div>
							...
							<div class="boardWriteItem">
								...
								<div class="boardInputBox">
									<input id="subject" name="subject" type="text" class="longInput" value = "<?php if($num != ""){ echo($result["MAIL_SUBJECT"]); } else {}?>">
								</div>
							</div>
							<div class="boardWriteItem">
								<div class="boardName">
								...
								<div class="boardContextBox" id="context">
									<div class="subContentWriteControl">
										...
										<div class="buttonExtraGroup">
											<div class="contentListButton">
												<img class="buttonLeft" src="/app/images/buttonBack_01.gif" alt="버튼 테두리" /> 
												<a id="btnSetForeColor" href="javascript:insertForeColor('colorPane', 'btnSetBackColor', 'dvColorPane')"> 
											...
											<div class="contentListButton">
												<img class="buttonLeft" src="/app/images/buttonBack_01.gif" alt="버튼 테두리" /> 
												<a id="btnSetBackColor" href="javascript:insertBackColor('colorPane', 'btnSetBackColor', 'dvColorPane')"> 
...
?>
									...
									<input type="hidden" id="mail_context" name="mail_context" />
						...
						<div class="boardListButtonBox">
							<div id="registerBoard" class="buttonBox">
								<a href="javascript:registerMail('frmMail', 'mailTo', 'subject', 'textEdit', 'mail_context', 'viewfilelist', 'file_list', 'image_list')">
									<span class="buttonText">보내기</span>
								</a>
							</div>
						</div>
					</form>
	...
	<script type="text/javascript" src="/app/js/mailEditor.js?v=1.21">
	</script>
