...
try
{
    ...
    $count      = $board->getboardcount("3");
    $page       = $_GET["page"];
    $paging     = $board->makePaging($count, $page);
    $result     = $board->getBoardList("3", $paging);
} 
catch (CException $ex) 
{
    $ex->printException();
...
?>	
            	<div class="contentBox">
					<div class="boardTitle">
						<img src="/app/images/admin/title_mark.gif" /> <span>1대1 고객지원</span>
					</div>
					<div class="boardBox">
...
?>
        						<li id="sample_advertiselist">
									<div class="boardListItem">
        								...
        								<a id="adverName" href="/admin_manager.php?mode=boardsupportview&num=<?php echo($items["NUM"]); ?>"> 
...
?>
					...
					<div class="boardListButtonBox">
						<div class="buttonLeftBox">
							<a id="boardprev" href="/admin_manager.php?mode=boardsupportlist&page=<?php echo($paging["boardprev"])?>">
...
?>
    						<div class="buttonLeftBox">
								<a id="page" href="/admin_manager.php?mode=boardsupportlist&page=<?php echo($i)?>">
...
?>
						...
						<div class="buttonLeftBox">
							<a id="boardnext" href="/admin_manager.php?mode=boardsupportlist&page=<?php echo($paging["boardnext"])?>">
								<span class="buttonText">▶</span>
							</a>
						</div>
					</div>
