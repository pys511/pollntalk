...
?>
				...
				<div class="contentBox">
					<form id="frmBoardInfo" action="/admin_controller.php?mode=board_proc" method="post">
    					...
    					<input type="hidden" id="member_seq" name="member_seq" value="<?php echo($result["MEMBER_SEQ"]); ?>" />
    					...
    					<div class="boardBox">
    						...
    						<div class="boardWriteItem">
    							...
    							<div class="boardContextBox" id="context">
    								<div style="float:left; width:75%; border:1px #e6e6e6 solid;">
...
?>
					...
					<form id="frmBoard" action="/admin_controller.php?mode=board_proc" method="post">
						<div class="boardBox">
							<input type="hidden" id="SUB_NUM" name="NUM" value="<?php echo($num); ?>" />
							<input type="hidden" id="PARENT_NUM" name="PARENT_NUM" value="<?php echo($num); ?>" />
