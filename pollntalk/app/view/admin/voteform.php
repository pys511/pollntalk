...
?>	
            	<form id="frmVote" method="post" action="/admin_controller.php?mode=vote_form_proc">
					<input type="hidden" id="vote_form_seq" name="vote_form_seq" value="<?php echo($vote_form_seq); ?>" />
					<div class="contentBox">
						<div class="boardTitle">
							<img src="/app/images/admin/title_mark.gif" /> <span>투표 양식 만들기</span>
						</div>
						<div class="boardBox">
...
?>
								...
								<div class="categorybox">
									...
									<select id="cate_2dept_seq" name="vote_cate2_seq">
										<option value="-">-</option>
<?php
if ($vote_cate1_seq != "" && $vote_cate1_seq != "0") 
{
							...
							<div class="boardWriteItem">
								...
								<div class="boardImageInputBox">
									<div class="boardinputarea">
										<!-- <input type="radio" id="resource_type_00" name="resource_type[]" value="0" <?php if ($vote_real_type == "0") { ?> checked <?php } else if ($vote_real_type == "") {?> checked <?php } ?>/>
										<label for="resource_type_00">
											<span>이미지/동영상 없음</span>
										</label> -->
										<input type="radio" id="resource_type_01" name="resource_type[]" value="1" <?php if ($vote_real_type == "1") { ?> checked <?php } else if ($vote_real_type == "") {?> checked <?php } ?>/>
										<label for="resource_type_01">
											<span>카테고리 사진</span>
										</label>
										<input type="radio" id="resource_type_02" name="resource_type[]" value="2" <?php if ($vote_real_type == "2") { ?> checked <?php } ?> />
										<label for="resource_type_02">
											<span>사진 URL</span>
										</label>
										<input type="radio" id="resource_type_03" name="resource_type[]" value="3" <?php if ($vote_real_type == "3") { ?> checked <?php } ?> />
										...
										<div class="votewritebox">
											<div class="questionbox">
												...
												<div class="boardWriteItem">
													...
													<div class="boardImageInputBox">
														<div class="boardinputarea">
															<input type="radio" class="question_resource_type_00" id="question_resource_type_00" name="question_resource_type[]" value="0" checked />
                                                            <label class="question_resource_label_00" for="question_resource_type_00">
                                                            <span>사진/동영상 없음</span>
                                                            </label>
                    										<input type="radio" class="question_resource_type_01" id="question_resource_type_01" name="question_resource_type[]" value="1" />
                    									...
                    									<div class="boardinputarea">
    														...
    														<img class="imageFile" src="/app/images/no_image.png" width="160" height="160" />
											...
											<ul id="answer_lst" class="answer_lst">
												...
												<input class="answer_index" type="hidden" id="answer_index" name="answer_index" />
													...
													<div class="boardWriteItem">
														...
														<div class="boardImageInputBox">
															<div class="boardinputarea">
																<input type="radio" class="answer_resource_type_00" id="answer_resource_type_00" name="answer_resource_type[]" value="0" checked />
                        										<label class="answer_resource_label_00" for="answer_resource_type_00">
                        											<span>사진/동영상 없음</span>
                        										</label>
                        										<input type="radio" class="answer_resource_type_01" id="answer_resource_type_01" name="answer_resource_type[]" value="1" />
										...
										<div class="votewritebox">
											<div class="questionbox">
												...
												<div class="boardWriteItem">
													...
													<div class="boardImageInputBox">
														<div class="boardinputarea">
															<input type="radio" class="question_resource_type_00" id="question_resource_type_00" name="question_resource_type[]" value="0" <?php if ($question_resource_type == "0") { ?> checked <?php } ?> />
                                                            <label class="question_resource_label_00" for="question_resource_type_00">
                                                            <span>사진/동영상 없음</span>
                                                            </label>
...
?>
                    							<li class="answer_lst_item newAnswerItem">
													...
													<div class="boardWriteItem">
														<div class="boardName">
															<span>응답 이미지/동영상</span>
														</div>
														<div class="boardImageInputBox">
															<div class="boardinputarea">
																<input type="radio" class="answer_resource_type_00" id="answer_resource_type_00" name="answer_resource_type[]" value="0" <?php if ($answer_resource_type == "0") { echo("checked"); } ?> />
                        										<label class="answer_resource_label_00" for="answer_resource_type_00">
                        											<span>이미지/동영상 없음</span>
                        										</label>
...
?>
	...
	<script type="text/javascript" src="/app/js/admin_vote_register.js?v=1.67" charset="utf-8">
	</script>
	<!-- admin 정보 등록 js -->
