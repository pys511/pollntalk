...
$adverInfo      = $adsetCtrl->getAdverByPosition("7");
?>
...
?>
			...
			<div class="paging">
				...
				<a id="boardprev" href="/?mode=event_votelist&page=<?php echo($paging["boardprev"])?>&cate_seq=<?php echo($cate_seq); ?>&cate_sub_seq=<?php echo($cate_sub_seq); ?>">
...
?>
				<div class="pagingbutton <?php if($page == $i) echo("pageselect"); ?>">
					<a id="page" href="/?mode=event_votelist&page=<?php echo($i)?>&cate_seq=<?php echo($cate_seq); ?>&cate_sub_seq=<?php echo($cate_sub_seq); ?>">
...
?>
				<a id="boardprev" href="/?mode=event_votelist&page=<?php echo($paging["boardnext"])?>&cate_seq=<?php echo($cate_seq); ?>&cate_sub_seq=<?php echo($cate_sub_seq); ?>">
